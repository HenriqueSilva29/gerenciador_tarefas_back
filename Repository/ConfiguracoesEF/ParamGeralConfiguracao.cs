...
{
    public class ParamGeralConfiguracao : IEntityTypeConfiguration<ParamGeral>
    {
        public void Configure(EntityTypeBuilder<ParamGeral> builder)
        {
            ...
            builder.HasOne(p => p.Usuario)
                .WithOne(u => u.ParamGeral)
                .HasForeignKey<ParamGeral>(p => p.CodigoUsuario)
                .OnDelete(DeleteBehavior.Cascade);

            builder.HasIndex(p => p.CodigoUsuario)
                .IsUnique();
            ...
            builder.Property(p => p.Unidade)
                 ...
                 .HasConversion<int>()
                 .HasDefaultValue(EnumUnidadeTempo.Minutos);
